...
public class RedisZrevRangeByLexHandler extends AbstractRedisCommandHandler {

    public RedisZrevRangeByLexHandler() {
    ...
    protected Promise<BElement, Exception> process(RedisClient redis, BObject options, BElement[] params) {
        ...
        return redis.zrevrangebylex(params[0].asValue().getRaw(), includeLower, params[1].asValue().getRaw(), params[2].asValue().getRaw(), includeUpper,
                offset, count);
    }
}
