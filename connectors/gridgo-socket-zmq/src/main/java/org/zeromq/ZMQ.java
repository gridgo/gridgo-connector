...
public class ZMQ {
     ...
     * @param capture  If the capture socket is not NULL, the proxy shall send all
     *                 messages, received on both frontend and backend, to the
     *                 capture socket. The capture socket should be a ZMQ_PUB,
     ...
     * 
     * @param ioThreads Number of threads to use, usually 1 is sufficient for most
     *                  use cases.
     * @return the Context
     */
    ...
    public static class Socket implements Closeable {
         ...
         * 
         * @param timeout Timeout for receive operation in milliseconds. Default -1
         *                (infinite)
         */
         ...
         * 
         * @param swap The value of 'ZMQ_SWAP' defines the maximum size of the swap
         *             space in bytes.
         */
         ...
         * 
         * @param optVal The value of 'ZMQ_TCP_KEEPALIVE' to turn TCP keepalives on (1)
         *               or off (0).
         */
         ...
         * 
         * @param optVal The value of 'ZMQ_TCP_KEEPALIVE_CNT' defines the number of
         ...
         * 
         * @param optVal The value of 'ZMQ_TCP_KEEPALIVE_INTVL' defines the interval
         ...
         * default.
         * 
         * @param optVal The value of 'ZMQ_TCP_KEEPALIVE_IDLE' defines the interval
         *               between the last data packet sent over the socket and the first
         *               keepalive probe. Unit is OS dependant.
         */
         ...
         * IPv4 and IPv6 hosts.
         * 
         * @param v4only A value of true will use IPv4 sockets, while the value of false
         ...
         * 
         * @param mandatory A value of false is the default and discards the message
         *                  silently when it cannot be routed. A value of true returns
         *                  an EHOSTUNREACH error code if the message cannot be routed.
         */
         ...
         * 
         * @param domain For NULL security (the default on all tcp:// connections), ZAP
         *               authentication only happens if you set a non-empty domain. For
         *               PLAIN and CURVE security, ZAP requests are always made, if
         *               there is a ZAP handler present. See
         ...
         *
         * @param conflate A value of false is the default which means socket preserves
         *                 all messages with respect to the RECVHWM and SENDHWM options.
         *                 A value of true means only last message is kept ignoring the
         ...
         *
         * @param immediate A value of false is the default which means socket will not
         *                  queue messages to to incomplete connections. This will cause
         *                  the socket to block if there are no other connections, but
         *                  will prevent queues from filling on pipes awaiting
         *                  connection.
         * @since 3.2.0
         */
         ...
         * messages.
         *
         * @param isProbeRouter if {@code true}, the socket will automatically send an
         *                      empty message when a new connection is made or accepted;
         *                      if {@code false}, no such message will be sent
         * @since 4.0.0
         */
    ...
    public static class Poller {
         ...
         * 
         * @param tout the timeout, as per zmq_poll if -1, it will block indefinitely
