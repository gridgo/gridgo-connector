...
public class FileRotationUnitTest {
    ...
    private void doTestFile(String scheme, String format, String batchEnabled, String lengthPrepend) throws InterruptedException {
        ...
        var connector = new DefaultConnectorFactory().createConnector(
                scheme + "://[test." + lengthPrepend + "." + batchEnabled + "." + format + "]?format=" + format + "&batchingEnabled=" + batchEnabled
                        + "&lengthPrepend=" + lengthPrepend + "&limitStrategy=rotate&deleteOnStartup=true&deleteOnShutdown=true&maxBatchSize=1000&limitSize="
