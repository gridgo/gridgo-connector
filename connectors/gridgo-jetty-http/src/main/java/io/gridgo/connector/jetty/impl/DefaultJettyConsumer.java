...
public class DefaultJettyConsumer extends AbstractJettyConsumer {
    ...
    public DefaultJettyConsumer(ConnectorContext context, HostAndPort address, boolean http2Enabled, boolean mmapEnabled, String path,
            Set<JettyServletContextHandlerOption> options) {
        super(context, address, http2Enabled, mmapEnabled, path, options);
    }
